...
Clique <a href="https://github.com/Paulooo0/relational-db-college-activity/blob/main/modelo-fisico.sql">aqui</a> para acessar o arquivo .sql do `modelo físico`, que é o suficiente para replicar as tabelas e relações que foram utiizadas
